...
class Forest_Loss_Cb_NonCommodity extends CI_Controller {
	...
	{	
        // $this->load->view('frontend/forest/index');
	    //$setting= $this->Setting_model->get_setting()->row();
        //die("test");
        
		$awal["base_url"] = base_url();
		$awal["controller"] = 'Forests';
	    $this->load->view('frontend/html_awal', $awal);
	    $menu["active_menu"] = 'forests';
	    $this->load->view('frontend/header', $menu);
	    $this->load->view('frontend/forest_loss_cb_noncommodity/index');
