...
*/
		   //$Obj = (object)[];
		    $Obj = [];
		    $commodity = $this->model_commodity->get_all()->result();
		
			foreach($commodity as $p){
				$val = array('id' => $p->id_commodity,  'logo' => $p->thumbnail_off, 'name' => $p->commodity_name, 'subheader' => $p->subheader);
				array_push($Obj,(object) $val);
