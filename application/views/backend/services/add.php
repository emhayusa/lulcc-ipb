 <div id="page-wrapper" >
    ...
    <ol class="breadcrumb">
       ...
       <li class="active">Form Add Service</li>
   </ol> 

</div>

<div id="page-inner"> 
  <?php echo form_open("backend/services/insert", array('class' => 'form-horizontal')); ?>
            ...
            <div class="panel-body">
                <div class="form-group ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="RoleId" name="RoleId" placeholder="Role Id" value="<?php echo set_value('RoleId'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="CommodityId" name="CommodityId" placeholder="Commodity Id" value="<?php echo set_value('CommodityId'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="ServicesName" name="ServicesName" placeholder="Services Name" value="<?php echo set_value('ServicesName'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="URLServices" name="URLServices" placeholder="URL Services"  value="<?php echo set_value('URLServices'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="Layer" name="Layer" placeholder="Layer"  value="<?php echo set_value('Layer'); ?>">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo set_value('definition'); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="Resolution" name="Resolution" placeholder="Resolution"  value="<?php echo set_value('Resolution'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="Coverage" name="Coverage" placeholder="Coverage"  value="<?php echo set_value('Coverage'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="DataSource" name="DataSource" placeholder="Data Source"  value="<?php echo set_value('DataSource'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="Year" name="Year" placeholder="Year"  value="<?php echo set_value('Year'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="Frequency" name="Frequency" placeholder="Frequency"  value="<?php echo set_value('Frequency'); ?>">
                            <span class="text-danger"><?php echo form_error('Frequency'); ?></span>
                        </div>
                    </div>                    
                    <div class="form-group">
                        <label for="textLimitation" class="col-sm-2 control-label">Limitations (accuracy, data collection method, etc.)</label>
                        <div class="col-sm-10">
                            <textarea class="textarea" placeholder="input Limitation" id="Limitation" name="Limitation"
                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo set_value('Limitation'); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="input" class="form-control" id="License" name="License" placeholder="License"  value="<?php echo set_value('License'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo set_value('Citation'); ?></textarea>
