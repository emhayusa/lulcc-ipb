 <div id="page-wrapper" >
    ...
    <ol class="breadcrumb">
     ...
     <li class="active">Form Add Kabupaten</li>
 </ol> 

</div>

<div id="page-inner"> 
  <?php echo form_open("backend/kabupaten/insert", array('class' => 'form-horizontal')); ?>   
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="input" class="form-control" id="KabupatenName" name="KabupatenName" placeholder="Kabupaten Name" value="<?php echo set_value('KabupatenName'); ?>">
