 <div id="page-wrapper" >
    ...
    <ol class="breadcrumb">
       ...
       <li class="active">Form Edit Tutorial</li>
   </ol> 

</div>

<div id="page-inner"> 
  <?php echo form_open("backend/tutorial/update", array('class' => 'form-horizontal')); ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="input" class="form-control" id="TutorialTitle" name="TutorialTitle" placeholder="Tutorial Title" value="<?php echo set_value('TutorialTitle', $data->title); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <div class="radio1 radio-check radio-inline" >
                        <input type="radio" id="radio1" name="active" value="1" checked="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="input" class="form-control" id="URLTutorial" name="URLTutorial" placeholder="URL Tutorial" value="<?php echo set_value('URLTutorial', $data->url); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7 control-label">
                        <input type="file" id="UploadFile" name="UploadFile" placeholder="Upload File"  value="<?php echo set_value('UploadFile', $data->file); ?>">
